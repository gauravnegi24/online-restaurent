<?php
 ...
 ///
  ...
  $output = '';
    ...
    $rating = mysqli_query($con, "SELECT * FROM store_leaves LIMIT $start_from,$record_per_page");

                                        $leave = mysqli_query($con,"SELECT * FROM store_leaves");
        ...
        $page_query = "SELECT * FROM store_leaves ORDER BY leave_id ASC";
