...
$item = mysqli_query($con,"SELECT * FROM item_table");
?>
                ...
                <div class="card">
                                        <div class="card-body">
                                          <div class=" card-title" style="margin:30px;">
                                            <h4 style="font-size:20px;text-align:center;" class="">Items Details</h4>
                                          </div>
                                            <div class="table-responsive">
                                                <table id="zero_config" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                      <?php while ($itm = mysqli_fetch_array($item)) {
                                                      ?>
                                                        <tr>
                                                            <td><?php echo $itm['item_name']; ?></td>
                                                            <td><?php echo $itm['item_unit']; ?></td>
                                                            <td><?php echo $itm['total_item']; ?></td>
                                                            <td><?php echo $itm['item_status']; ?></td>
                                                        </tr>
                                                     <?php } ?>
                                                    </tbody>
                                                    <tfoot>
