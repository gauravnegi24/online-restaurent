            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                      ...
                      <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="inventory.php" aria-expanded="false"><i class="fas fa-plus"></i><span class="hide-menu">Inventory Manage</span></a></li>
                      <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="storeleave.php" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Store Employee Leaves</span></a></li>
                      <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="empleaves.php" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Employee Leaves</span></a></li>
